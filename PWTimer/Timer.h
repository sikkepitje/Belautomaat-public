...
public:
  ...
  int8_t every(unsigned long period, voidfunction_t callback);
  int8_t every(unsigned long period, voidfunction_t callback, int repeatCount);
  int8_t after(unsigned long duration, voidfunction_t callback);
