...
/*  * * * * * * * * * * * * * * * * * * * * * * * * * * *
 ...
 v2.1 -> 2.2 modified by Paul Wiegmans
 removed: context 
 changed callback function prototype to "void(*callback()" to prevent compiler warnings
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
int8_t Timer::every(unsigned long period, voidfunction_t callback, int repeatCount)
{
...
int8_t Timer::every(unsigned long period, voidfunction_t callback)
{
    return every(period, callback, -1); // - means forever
}

int8_t Timer::after(unsigned long period, voidfunction_t callback)
{
